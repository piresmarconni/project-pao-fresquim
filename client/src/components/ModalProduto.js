...
export default function ModalProduto({
  ...
  // Preenche o form quando for editar, ou limpa quando for criar
  useEffect(() => {
    if (produtoEditando) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            value={formData.nome}
            onChange={(e) => {
              // Aceita letras, números e espaços (ex: Pão 50g)
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              required
              type="text" // Usamos text com regex para evitar setinhas chatas do tipo number
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 outline-none focus:border-orange-500"
